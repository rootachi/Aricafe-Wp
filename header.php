...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/lib/animate/animate.css">
</head>
                ...
                <nav class="navbar navbar-expand-lg navbar-light"> 
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-0 mx-lg-auto">
                            <a href="<?php echo get_template_directory_uri(); ?>/front-page" class="nav-item nav-link active">Home</a>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                ...
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="<?php echo get_site_url();?>/index.php/">Home</a></li>
